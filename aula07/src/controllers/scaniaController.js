let telemetriaScania = [
	{ id: 1, modelo: "R450", vin: "9BS123456789",
		temperatura_motor: 88, status: "OK" },
	{ id: 2, modelo: "S500", vin: "9BS987654321",
		temperatura_motor: 102, status: "ALERTA_AQUECIMENTO" }
];
...
const scaniaController = {
	...
	registrarTelemetria: (req, res) => {
		...
		const novoRegistro = {
			...
			status: temperatura_motor > 95 ?
"ALERTA_AQUECIMENTO" : "OK"
		};
